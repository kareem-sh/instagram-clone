<div class="card">
    ...
    <div class="card-body">
        <div class="max-h-[35rem] overflow-hidden">
            <img src="storage/app/public/{{ $post->image }}" class="h-auto w-full object-cover"
        ...
        <form action="/p/{{ $post->slug }}/comment" method="POST">
            ...
            <div class="flex flex-row">
                <textarea name="body" placeholder="{{ __('Add a comment ...') }}" autocomplete="off" autocorrect="off"
                    class="grow border-none resize-none foucs:ring-0 outline-0 bg-none max-h-60 h-5 p-0 overflow-y-hidden placeholder-gray-400"></textarea>
